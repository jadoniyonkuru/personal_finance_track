import type { AppData, Budget, BudgetProgress, TransactionCategory } from "./types.js";
...
export function renderBudgets(
  ...
  container.querySelectorAll<HTMLButtonElement>(".delete-budget").forEach((btn) => {
...
export function bindBudgetForm(
...
export function bindDeleteBudget(
  getData: () => AppData,
  setData: (d: AppData) => void
): (id: string) => void {
  return (id: string) => {
